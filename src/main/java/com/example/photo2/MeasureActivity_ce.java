...
public class MeasureActivity_ce extends AppCompatActivity {
...
//    }
    ...
    private static final String TAG = MeasureActivity_ce.class.getSimpleName();
    ...
    // 上传后 服务端返回的图片链接
    public static String uploadUrlce = "";
...
//    final MotionEvent upEvent2 = MotionEvent.obtain(downTime, downTime, MotionEvent.ACTION_UP,800,1000, 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_measure_ce);

        arFragment = (ArFragment) getSupportFragmentManager().findFragmentById(R.id.ux_fragment);
        rectangleview = (View) findViewById(R.id.viewce);
                ...
                (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                    ...
                    if (anchor1 == null) {
                        ...
                        if(Math.abs((fl_measurement-fl_measurement34))<0.2f) {
                            ...
                            Uri photoPath = saveImage("ce_"+date+"_"+measurement, mScreenBitmap);
...
//                    onSuccessCallback(mScreenBitmap);
    ...
    public Uri saveImage(String name, Bitmap bitmap) {
        ...
        try {
            ...
            Bitmap bitmap1 = Bitmap.createBitmap(bitmap, bitmap.getWidth()/2-225, bitmap.getHeight()/2-900, 450, 1800);
...
//            Uri localUri = Uri.fromFile(file);
    ...
    TakePhotoHelper.TakePhotoCallback callback = new TakePhotoHelper.TakePhotoCallback() {
        ...
        public FragmentManager getSupportFragmentManager() {
            return MeasureActivity_ce.this.getSupportFragmentManager();
        }
    };

// 侧视
    void showTypeDialog(String photoPath) {
        final String[] items = {"板厚测量", "板弯锥度", "鼓包检测","裂纹检测"};
...
//            apiUrl = "http://172.20.10.2:5001/upload/0";
            apiUrl = "http://" + ip_Local +":5001/upload/ce00";
        }
        else if (type == 1){
            // 类型2的接口
            apiUrl = "http://" + ip_Local +":5001/upload/ce01";
        }
        else if (type == 2){
            // 类型3的接口
            apiUrl = "http://" + ip_Local +":5001/upload/ce02";
        }
        else{
            // 类型4的接口
            apiUrl = "http://" + ip_Local +":5001/upload/ce03";
        }
        progressDialog.show();
        // 创建一个OkHttpClient实例
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MeasureActivity_ce.this,"上传失败：" + e.getLocalizedMessage(),Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    if (response.isSuccessful()) {
                        uploadUrlce = response.body().string();
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
